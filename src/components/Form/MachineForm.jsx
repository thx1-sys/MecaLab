...
import StepOne from "./RequestsStudentMachine/StepOne";
import StepTwo from "./RequestsStudentMachine/StepTwo";
import StepThree from "./RequestsStudentMachine/StepThree";
import StepContextData from "./RequestsStudentMachine/StepContextData"; // Importa el nuevo paso
import StepIndicator from "./StepIndicator";
import IconChevronLeft from "./Icons/IconChevronLeft";

const MachineForm = ({ onBack }) => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-white font-bold text-2xl mb-3">
        Formulario para solicitar maquinaria
      </h2>
